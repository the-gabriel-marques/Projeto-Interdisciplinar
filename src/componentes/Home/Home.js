...
content.className = 'section_all';content.id = 'section_all'
content.innerHTML = `
    <section class="tela_desktop">
                ...
                <div class="content_produto_desktop">
                    ...
                    <div class="esquerda_produto_desktop card">
                        <div class="produto_desktop_img flip">
                            <div class="front-card">
                                <img src="./src/componentes/produtos/img/c2-cópia.jpg" alt="m1">
                            </div>
                            <div class="back-card">
            ...
            <br>
            <br>
            <article class="container_production_desktop" id="producao-section">
            ...
            <article class="container_data_desktop" id="dados-section">
